    ...
    <section id="featured-products" className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
            ...
            <Card key={product.id} className="group overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
              ...
              <CardContent className="p-6">
                ...
                <div className="flex gap-2 mt-4">
                  <Button 
                    className="flex-1 bg-amber-600 hover:bg-amber-700 text-white rounded-full transition-all duration-300"
                  >
                    Add to Cart
                  </Button>
                  <Button 
                    variant="outline" 
                    className="px-4 border-amber-600 text-amber-600 hover:bg-amber-600 hover:text-white rounded-full transition-all duration-300"
                  >
                    ♡
                  </Button>
                </div>
        ...
        <div className="text-center mt-16">
          <Button 
            size="lg"
            className="bg-neutral-900 hover:bg-neutral-800 text-white px-12 py-4 text-lg font-semibold rounded-full transition-all duration-300 transform hover:scale-105"
          >
